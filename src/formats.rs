...
pub fn format_node_compact(n : usize) -> String
{
  ...
  if n <         10_000_000 { let r = (n +             499) /             1_000; return format!("{q}{r:4}{u}k{d}"); }
  if n <     10_000_000_000 { let r = (n +         499_999) /         1_000_000; return format!("{q}{r:4}{u}m{d}"); }
  if n < 10_000_000_000_000 { let r = (n +     499_999_999) /     1_000_000_000; return format!("{q}{r:4}{u}g{d}"); }
                              let r = (n + 499_999_999_999) / 1_000_000_000_000; return format!("{q}{r:4}{u}t{d}");
}
