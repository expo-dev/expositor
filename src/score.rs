...
//   in the range 80.00 to 89.99 indicate mates that are forceable but potentially quite long,
//   absolute scores in the range 90.00 to 99.99 indicate mates that are unproven but inevitable
//   with reasonable play, and absolute scores in the range 100.00 to 249.99 indicate proven
//   mates. A score of -250.00 means the game is over.
//
...
pub const MINIMUM_PROVEN_MATE : i16 =  200_00;
pub const MINIMUM_PROVEN_LOSS : i16 = -200_00;

pub const INEVITABLE_MATE : i16 =  90_00;
pub const INEVITABLE_LOSS : i16 = -90_00;

pub const LIKELY_MATE : i16 =  80_00;
pub const LIKELY_LOSS : i16 = -80_00;
