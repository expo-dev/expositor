...
pub struct Configuration {
  pub index_mask   : AtomicUsize, //  8   8
...
#[repr(align(64))]
pub struct Globals {
  pub cache      : Vec<TableEntry>, //  24  24
...
#[inline] pub fn index_mask      () -> usize { unsafe { return CONF.index_mask  .load(Acquire); } }
...
#[inline] pub fn set_index_mask (mask : usize) { unsafe { CONF.index_mask  .store(mask, Release); } }
...
pub fn increment_generation()
{
  ...
  //   be relaxed (this doesn't need to become a `lock inc` instruction or anything).
