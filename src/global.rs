...
pub struct Configuration {
  pub num_entries  : AtomicUsize, //  8   8
...
#[inline] pub fn num_entries     () -> usize { unsafe { return CONF.num_entries .load(Acquire); } }
...
#[inline] pub fn set_num_entries(n : usize) { unsafe { CONF.num_entries .store(n, Release); } }
